<template>
  <div class="bentoGrid">
    <div class="gridFirst">
      ...
      <div :style="{ backgroundImage: `url(${i18n.global.locale.value === 'en' ? y2En : y2Ru})` }" class="b"></div>
...
// const cLocale = ref(Tr.currentLocale)

// watch(i18n.global.locale.value, function (newVal, oldVal) {
//   console.log('locale change', newVal)
//   cLocale.value = Tr.currentLocale
// })
...
#card2 {
  ...
  background-size: cover;
  background-position: center;
  background-image: url('/src/assets/icons/bentoMarket.png');
}
#card3 {
  grid-column: 2;
  grid-row: 2;
  ...
  background-size: cover;
  background-position: center;
  background-image: url('/src/assets/icons/bentoNetwork.png');
}
#card4 {
  grid-column: 1 / span 2;
  grid-row: 3;
  ...
  background-size: cover;
  background-position: center;
  background-image: url('/src/assets/icons/bentoProjects.png');
}
#card5 {
  grid-column: 1 / span 2;
  grid-row: 4 / span 2;
  ...
  background-size: cover;
  background-position: center;
  background-image: url('/src/assets/icons/bentoX.png');
}
#card6 {
  grid-column: 1 / span 2;
  grid-row: 6;
